...
class DualListSelectorPane extends React.Component {
    ...
    render() {
        ...
        filterOption, onOptionSelect } = _a, props = tslib_1.__rest(_a, ["isChosen", "title", "actions", "isSearchable", "searchInputAriaLabel", "className", "status", "selectedOptions", "options", "id", "filterOption", "onOptionSelect"]);
        ...
        return (React.createElement("div", Object.assign({ className: react_styles_1.css(dual_list_selector_1.default.dualListSelectorPane, isChosen ? dual_list_selector_1.default.modifiers.chosen : 'pf-m-available', className) }, props),
            ...
            options && (React.createElement("div", { className: react_styles_1.css(dual_list_selector_1.default.dualListSelectorMenu), ref: this.menuEl, tabIndex: 0 },
