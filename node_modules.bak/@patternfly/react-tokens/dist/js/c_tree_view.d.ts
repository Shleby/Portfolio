export const c_tree_view: {
  ".pf-c-tree-view": {
    ...
    "c_tree_view__node_toggle_Transition": {
      "name": "--pf-c-tree-view__node-toggle--Transition",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 1))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 1))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 1))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 1))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 1))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 1))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 2))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 2))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 2))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 2))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 2))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 2))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 3))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 3))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 3))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 3))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 3))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 3))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 4))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 4))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 4))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 4))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 4))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 4))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 5))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 5))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 5))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 5))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 5))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 5))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 6))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 6))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 6))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 6))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 6))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 6))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 7))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 7))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 7))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 7))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 7))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 7))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 8))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 8))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 8))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 8))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 8))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 8))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 9))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 9))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 9))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 9))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 9))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 9))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
  ...
  ".pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item .pf-c-tree-view__list-item": {
    "c_tree_view__node_PaddingLeft": {
      "name": "--pf-c-tree-view__node--PaddingLeft",
      "value": "calc(calc(1.5rem + 1rem) + (1.5rem * 10))",
      "values": [
        "calc(--pf-c-tree-view__node--indent--base + (--pf-c-tree-view__node--nested-indent--base * 10))",
        "calc(calc(--pf-global--spacer--lg + --pf-global--spacer--md) + (--pf-global--spacer--lg * 10))",
        "calc(calc($pf-global--spacer--lg + $pf-global--spacer--md) + ($pf-global--spacer--lg * 10))",
        "calc(calc(pf-size-prem(24px) + pf-size-prem(16px)) + (pf-size-prem(24px) * 10))",
        "calc(calc(1.5rem + 1rem) + (1.5rem * 10))"
      ]
    },
    "c_tree_view__list_item__list_item__node_toggle_Left": {
      "name": "--pf-c-tree-view__list-item__list-item__node-toggle--Left",
